// Code from https://github.com/HokageMinato/SerializedTuplesForUnity
...
namespace SerializedTuples.Runtime
{
    ...
    public class SerializedTuple<T>
    {
        ...
        public MT GetPropertyValueByIdx<MT>(int index)
        {
            switch (index)
            {
                ...
                default:
                    throw new Exception(
                        $"InvalidIndexRequestException, Since its trying to access a non existant variable at index {index}!"
                    );
            }
        }
    ...
    public class SerializedTuple<T1, T2> : SerializedTuple<T1>
    {
        ...
        public new T GetPropertyValueByIdx<T>(int index)
        {
            switch (index)
            {
                ...
                default:
                    throw new Exception(
                        "Some error, since its trying to access a non existant variable !"
                    );
            }
        }
        #endregion
    ...
    public class SerializedTuple<T1, T2, T3> : SerializedTuple<T1, T2>
    {
        ...
        public SerializedTuple(T1 v1, T2 v2, T3 v3)
            : base(v1, v2)
        {
            this.v3 = v3;
        }
    ...
    public class SerializedTuple<T1, T2, T3, T4> : SerializedTuple<T1, T2, T3>
    {
        ...
        public SerializedTuple(T1 v1, T2 v2, T3 v3, T4 v4)
            : base(v1, v2, v3)
        {
            this.v4 = v4;
        }
    ...
    public class SerializedTuple<T1, T2, T3, T4, T5> : SerializedTuple<T1, T2, T3, T4>
    {
        ...
        public SerializedTuple(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5)
            : base(v1, v2, v3, v4)
        {
            this.v5 = v5;
        }
    ...
    public class SerializedTuple<T1, T2, T3, T4, T5, T6> : SerializedTuple<T1, T2, T3, T4, T5>
    {
        ...
        public SerializedTuple(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6)
            : base(v1, v2, v3, v4, v5)
        {
            this.v6 = v6;
        }
    ...
    [Serializable]
    public class SerializedTuple<T1, T2, T3, T4, T5, T6, T7>
        : SerializedTuple<T1, T2, T3, T4, T5, T6>
    {
        public T7 v7;

        public SerializedTuple(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6, T7 v7)
    ...
    [Serializable]
    public class SerializedTuple<T1, T2, T3, T4, T5, T6, T7, T8>
        : SerializedTuple<T1, T2, T3, T4, T5, T6, T7>
    {
        public T8 v8;

        public SerializedTuple(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6, T7 v7, T8 v8)
    ...
    [Serializable]
    public class SerializedTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        : SerializedTuple<T1, T2, T3, T4, T5, T6, T7, T8>
    {
        public T9 v9;

        public SerializedTuple(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6, T7 v7, T8 v8, T9 v9)
    ...
    [Serializable]
    public class SerializedTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
        : SerializedTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>
    {
        public T10 v10;
        ...
        public SerializedTuple(
            ...
            : base(v1, v2, v3, v4, v5, v6, v7, v8, v9)
        {
            this.v10 = v10;
        }
